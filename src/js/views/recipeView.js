...
class RecipeView extends View {
  ...
  //// display recipe in the user
  addHeandelrUpdateServing(heander) {
    this._pearantElement.addEventListener('click', function (e) {
      ...
      if (updateTo > 0) {
        ...
        alert('can not decrise this recipe');
      }
    });
  }
  addheandelrBookmark(heandler) {
    this._pearantElement.addEventListener('click', function (e) {
    ...
    <div class="recipe__ingredients">
      ...
      <ul class="recipe__ingredient-list">
        ${this._data.ingredients
          .map(ing => this._generateMarkupIngredants(ing))
          .join('')}
      </ul>
    </div>
